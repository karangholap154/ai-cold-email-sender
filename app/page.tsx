...
export default function LandingPage() {
  ...
  return (
    <main className="flex flex-1 flex-col bg-paper text-ink selection:bg-[#E4DFD3]">
      {/* 1. HERO SECTION */}
      <section className="relative border-b border-hairline px-6 pt-16 pb-20 sm:pt-24 sm:pb-28">
        <div className="mx-auto max-w-4xl">
          {/* Eyebrow badge */}
          <div className="inline-flex items-center gap-2 rounded-sm border border-hairline bg-[#EDEAE2] px-3 py-1 text-[11px] font-medium tracking-wide uppercase text-muted-ink">
            <span className="h-1.5 w-1.5 rounded-full bg-seal"></span>
            <span>Executive correspondence tool for candidates</span>
          </div>

          {/* Main Title */}
          <h1 className="font-heading mt-6 text-4xl sm:text-5xl md:text-6xl text-ink tracking-tight leading-[1.12]">
            Cold outreach that reads like you took the time.
          </h1>

          {/* Subheading */}
          <p className="mt-6 max-w-2xl text-base sm:text-lg text-muted-ink leading-relaxed">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <Link
              href="/draft"
              className="inline-flex items-center gap-2 rounded-sm bg-seal px-6 py-3 text-xs sm:text-sm font-medium text-paper hover:bg-seal/90 shadow-xs transition-all"
            >
            ...
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 rounded-sm border border-hairline bg-paper px-6 py-3 text-xs sm:text-sm font-medium text-ink hover:bg-[#EDEAE2] transition-colors"
            >
          ...
          {/* Value Proof Badges */}
          <div className="mt-10 flex flex-wrap items-center gap-y-3 gap-x-8 text-xs text-muted-ink border-t border-hairline pt-6">
      ...
      <section className="border-b border-hairline bg-[#FAF9F5] px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-4xl">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <div>
              <span className="text-[11px] font-medium uppercase tracking-wider text-muted-ink">
                Human-in-the-loop workflow
              </span>
              <h2 className="font-heading text-2xl sm:text-3xl text-ink mt-1">
                The Letter Frame
              </h2>
            ...
            {/* Toggle tabs */}
            <div className="flex items-center rounded-sm border border-hairline bg-paper p-1 text-xs shrink-0">
              <button
                type="button"
          ...
          {activeTab === "preview" ? (
            <div className="space-y-4">
              ...
              <div className="border border-hairline bg-paper p-4 rounded-sm">
                <div className="flex flex-wrap items-center justify-between gap-3 text-xs">
                  ...
                  <div className="flex flex-wrap items-center gap-1.5">
                    <span className="rounded-sm border border-hairline bg-[#EDEAE2] px-2 py-0.5 text-[11px] text-muted-ink">
                      Design Systems
                    </span>
                    <span className="rounded-sm border border-hairline bg-[#EDEAE2] px-2 py-0.5 text-[11px] text-muted-ink">
                      Next.js & WebGL
              ...
              <div className="border border-hairline bg-paper p-8 sm:p-10 rounded-sm shadow-[0_1px_3px_rgba(0,0,0,0.02)]">
                {/* Meta Header */}
                <div className="border-b border-hairline pb-4 mb-6 text-xs text-muted-ink flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <span className="text-muted-ink/70">To:</span>
                    <span className="font-mono text-ink font-medium">sarah.chen@linear.app</span>
                  </div>
                  <div className="inline-flex items-center gap-1.5 text-[11px] text-confirmed bg-confirmed/5 px-2 py-0.5 rounded-sm border border-confirmed/20">
                ...
                <div className="mb-6 space-y-1">
                  ...
                  <div className="font-heading text-lg sm:text-xl text-ink">
                    Linear Staff Frontend Engineer — background in high-performance design systems
                  </div>
                </div>

                {/* Letter Body */}
                <div className="space-y-4 text-sm sm:text-base leading-relaxed text-ink/90 font-serif">
                  <p>Hi Sarah,</p>
                  <p>
                ...
                <div className="mt-8 flex items-center justify-between border-t border-hairline pt-3 text-[11px] text-muted-ink">
                  <span>124 words • 1 min read</span>
                  <span className="italic">Restrained, direct, high-signal correspondence</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="inline-flex items-center gap-2 rounded-sm bg-seal px-5 py-2 text-xs font-medium text-paper shadow-xs">
...
- Strong product intuition and obsession with tactile micro-interactions.`}
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="border-t-2 border-ink pt-4 space-y-2">
              ...
              <h3 className="font-heading text-lg text-ink">Supply posting & contact</h3>
            ...
            {/* Step 2 */}
            <div className="border-t-2 border-seal pt-4 space-y-2">
              <span className="font-mono text-xs text-seal font-medium">02</span>
              <h3 className="font-heading text-lg text-ink">Inspect in Letter Frame</h3>
              <p className="text-xs sm:text-sm text-muted-ink leading-relaxed">
            ...
            {/* Step 3 */}
            <div className="border-t-2 border-confirmed pt-4 space-y-2">
              <span className="font-mono text-xs text-confirmed font-medium">03</span>
              <h3 className="font-heading text-lg text-ink">Dispatch via your Gmail</h3>
              <p className="text-xs sm:text-sm text-muted-ink leading-relaxed">
      ...
      <section className="border-b border-hairline bg-[#FAF9F5] px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-4xl space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {/* Conventional Tools */}
            <div className="border border-hairline bg-paper p-6 rounded-sm space-y-3">
      ...
      <section className="border-b border-hairline px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-4xl space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-hairline bg-paper p-5 rounded-sm space-y-2">
            ...
            <div className="border border-hairline bg-paper p-5 rounded-sm space-y-2">
              <div className="flex items-center gap-2 text-ink">
                <Building2 className="h-4 w-4 text-seal" />
      ...
      <section className="border-b border-hairline bg-[#FAF9F5] px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-4xl space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {/* Free Tier */}
            <div className="border border-hairline bg-paper p-8 rounded-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-baseline justify-between">
                  <h3 className="font-heading text-xl text-ink">Free</h3>
                  <div className="text-right">
                    <span className="font-heading text-2xl text-ink">$0</span>
              ...
              <Link
                href="/signup"
                className="w-full text-center rounded-sm border border-hairline bg-[#EDEAE2] py-2.5 text-xs font-medium text-ink hover:bg-[#E4DFD3] transition-colors"
              >
                Get started free
              </Link>
            </div>
            ...
            {/* Pro Tier */}
            <div className="border-2 border-seal bg-paper p-8 rounded-sm flex flex-col justify-between space-y-6 relative">
              <div className="absolute -top-3 right-6 bg-seal text-paper text-[10px] font-medium tracking-wide uppercase px-2 py-0.5 rounded-sm">
                Active Job Search
              </div>

              <div className="space-y-4">
                <div className="flex items-baseline justify-between">
                  <h3 className="font-heading text-xl text-ink">Pro</h3>
                  <div className="text-right">
                    <span className="font-heading text-2xl text-ink">$9</span>
                    <span className="text-xs text-muted-ink"> / month</span>
                  </div>
                </div>
                <p className="text-xs text-muted-ink leading-relaxed">
              ...
              <Link
                href="/signup"
                className="w-full text-center rounded-sm bg-seal py-2.5 text-xs font-medium text-paper hover:bg-seal/90 shadow-xs transition-all"
              >
                Upgrade to Pro
              </Link>
            </div>
            ...
            {faqs.map((faq, idx) => (
              <div key={idx} className="py-4">
                <button
                  ...
                  className="flex w-full items-center justify-between text-left text-sm font-medium text-ink hover:opacity-80 transition-opacity"
                >
                  <span>{faq.q}</span>
                  <ChevronDown
                ...
                {openFaq === idx && (
                  <p className="mt-2.5 text-xs sm:text-sm text-muted-ink leading-relaxed">
                    {faq.a}
                  </p>
                )}
              </div>
      ...
      <section className="border-b border-hairline bg-[#FAF9F5] px-6 py-16 sm:py-20 text-center">
        <div className="mx-auto max-w-2xl space-y-6">
          <h2 className="font-heading text-3xl sm:text-4xl text-ink tracking-tight">
      ...
      {/* 9. RESTRAINED FOOTER */}
      <footer className="px-6 py-12 text-xs text-muted-ink">
        <div className="mx-auto max-w-4xl flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-[11px]">
            ...
            <Link href="/log" className="hover:text-ink transition-colors">
              Send Log
            </Link>
        ...
        <div className="mx-auto max-w-4xl border-t border-hairline mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-muted-ink/80">
          <div>
