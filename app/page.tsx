            ...
            <form onSubmit={handleGenerate} className="space-y-6">
              ...
              <div className="flex items-center justify-end pt-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-sm bg-ink px-5 py-2.5 text-xs font-medium text-paper hover:bg-ink/90 disabled:opacity-50 transition-all shadow-xs"
                >
                  {isAnalyzing ? (
                    <>
